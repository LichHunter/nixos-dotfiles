...
--
myStartupHook = do
  spawnOnce "xrandr --output eDP --primary --mode 2560x1440 --pos 440x1440 --rotate normal --output DisplayPort-1 --off --output HDMI-1-0 --off --output DP-1-0 --off --output DP-1-1 --mode 3440x1440 --pos 0x0 --rotate normal"
  -- spawnOnce "polybar -q main -c \"~/.config/polybar/grayblocks/config.ini\""
