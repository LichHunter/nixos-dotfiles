...
* TODO Change hyprland config as nix config
...
* TODO [#C] Clean up in firefox_custom.nix
This is not a priority as I've updated main config and this can be removed at all
